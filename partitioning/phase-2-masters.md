...
**Summary:**
- Tables in scope: 111
- Partitioning recommended: 20 (8 RANGE, 0 RANGE+LIST, 12 HASH)
...
|---|---:|---:|---|---|---|---:|---|
| `d365.whsworkline` | 528223972 | 445547.46 | `modifieddatetime` | RANGE | monthly | 1 | 528M rows / 445 GB; D365 WHS module live 2023-02 onward; high CDC churn |
| `d365.inventdim` | 328020488 | 142929.09 | `modifieddatetime` | RANGE | quarterly | 2 | 328M rows; dimension rows only updated since 2025-06 - short window, quarterly is enough |
| `d365.whsworktable` | 239883244 | 136953.52 | `modifieddatetime` | RANGE | monthly | 1 | 239M rows / 136 GB; companion of whsworkline; same WHS-2023 timeline |
...
| `d365.whsloadline` | 45912598 | 58259.95 | `modifieddatetime` | RANGE | monthly | 1 | 45M rows / 58 GB; WHS-2023+ |
| `d365.whsloadtable` | 55828568 | 47756.11 | `modifieddatetime` | RANGE | monthly | 1 | 55M rows / 47 GB; WHS-2023+ |
| `d365.ecoresvalue` | 82913822 | 43290.38 | `modifieddatetime` | RANGE | quarterly | 1 | 82M rows / 43 GB; attribute catalog churns post-2023, quarterly windows are fine |
| `d365.whsshipmenttable` | 65611292 | 43067.12 | `modifieddatetime` | RANGE | monthly | 1 | 65M rows / 43 GB; shipment header, WHS-2023+ |
...
| `d365.ecorestextvalue` | 78921867 | 29782.20 | `modifieddatetime` | RANGE | quarterly | 1 | 78M rows / 29 GB; modifieddatetime 2023-02+ usable |
...
| `d365.usvcustomerresponsibilitiesemplentity` | 0 | 0 |
| `d365.usvdirpartycontactv3entity` | 0 | 0 |
| `d365.usvlogisticspostaladdressstagingview` | 0 | 0 |
| `d365.usvlogisticspostaladdressentity` | 0 | 0 |
| `d365.vendvendorexternalcodeentity` | 0 | 0 |
| `d365.whsworkusersessionlog` | 0 | 0.00 |
| `d365.inventwarehousepostaladdressentity` | 0 | 0 |
| `d365.usvdirpartypostaladdressstagingview` | 0 | 0 |
| `d365.usvlogisticscontactinfostagingview` | 0 | 0 |
| `d365.usvaiscustomerlookupbyorgnumsegmentstagingview` | 0 | 0 |
